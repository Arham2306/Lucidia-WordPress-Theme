...
class Post_Grid extends Widget_Base {
    ...
    private function get_query() {
        ...
        switch ( $source ) {
            ...
            case 'category':
                $cat_slugs = ! empty( $settings['category_slugs'] ) ? $settings['category_slugs'] : ( ! empty( $settings['category_slug'] ) ? $settings['category_slug'] : array() );
                if ( ! empty( $cat_slugs ) ) {
            ...
            case 'tag':
                $tag_slugs = ! empty( $settings['tag_slugs'] ) ? $settings['tag_slugs'] : ( ! empty( $settings['tag_slug'] ) ? $settings['tag_slug'] : array() );
                if ( ! empty( $tag_slugs ) ) {
