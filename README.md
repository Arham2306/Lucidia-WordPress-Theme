...
- 🧩 **Handcrafted Elementor Widget Suite**: 9 bespoke editorial widgets built natively for Elementor with deep query builders, select2 multi-filtering, line clamps, and responsive styling controls.
...
Lucidia includes a dedicated **Lucidia** category in Elementor with 9 handcrafted editorial widgets:
